// Mock of MapMarker with <TouchableOpacity testID /> to allow Detox .tap()
        ...
        { this.props.testID && (
          <>
            <TouchableOpacity onPress={() => {
                this.props.onPress(this.marker);
            }} 
              style={{position: 'relative', top: 80, marginTop: 20, marginLeft:10, height:20, width:20, backgroundColor: 'red'}}
